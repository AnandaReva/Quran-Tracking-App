...
import { AuthContext } from '../middlewares/AuthWrapper'; // Import AuthContext


const AuthPage = () => {

    const { error, signInWithEmailAndPassword, signUpWithEmailAndPassword, signInWithGoogle } = useContext(AuthContext);
